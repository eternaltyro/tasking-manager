...
def init_flask_restful_routes(app):
    ...
    from server.api.campaign_apis import CampaignAPI, GetAllCampaignProjectsAPI
    ...
    api.add_resource(CampaignAPI,                   '/api/v1/campaign/<int:campaign_id>', endpoint='get_update_campaign', methods=['GET', 'PATCH'])
    api.add_resource(CampaignAPI,                   '/api/v1/campaign/create', endpoint='create_campaign', methods=['POST'])
    api.add_resource(GetAllCampaignProjectsAPI,     '/api/v1/campaigns', endpoint='get_all_campaign', methods=['GET'])
